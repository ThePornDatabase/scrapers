...
class SiteTheFemaleOrgasmPerformerSpider(BasePerformerScraper):
    selector_map = {
        ...
        'pagination': '/explore/models/%s/popular/?g=',
        'external_id': r'model/(.*)/'
    }

    name = 'TheFemaleOrgasmPerformer'
    network = 'The Female Orgasm'

    start_urls = [
        'https://the-female-orgasm.com',
    ]
    ...
    def get_performers(self, response):
        ...
        for performer in performers:
            if "https:" not in performer:
                performer = "https://the-female-orgasm.com/explore/" + performer

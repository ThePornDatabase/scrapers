...
class SiteNickMarxxPerformerSpider(BasePerformerScraper):
    selector_map = {
        'pagination': '/_next/data/aPohmwtGBxAy_ZviMG-Fe/models.json?order_by=views&sort_by=desc&page=%s',
        'external_id': r'model/(.*)/'
    }

    name = 'NickMarxxPerformer'
    network = 'Nick Marxx'
    ...
    def get_performers(self, response):
        ...
        for performer in jsondata:
            ...
            item['url'] = f"https://nickmarxx.com/models/{performer['slug']}"

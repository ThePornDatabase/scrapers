...
class SiteJav888PerformerSpider(BasePerformerScraper):
    name = 'Jav888Performer'
    start_url = 'https://jav888.com'
    ...
    def start_requests(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://jav888.com', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_performers(self, response):
        ...
        for performer in jsondata:
            ...
            item['tattoos'] = ''
            item['network'] = 'Jav888'
            item['url'] = f"https://jav888.com/models/{performer['slug']}"

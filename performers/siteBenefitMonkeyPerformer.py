...
class SiteBenefitMonkeyPerformerSpider(BasePerformerScraper):
    name = 'BenefitMonkeyPerformer'
    start_url = 'https://www.benefitmonkey.com'
    ...
    def get_performers(self, response):
        ...
        for performer in jsondata:
            ...
            item['url'] = f"https://www.benefitmonkey.com/models/{performer['slug']}"

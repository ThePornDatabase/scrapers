...
class SitePOVClubPerformerSpider(BasePerformerScraper):
    selector_map = {
        ...
        'birthplace': '//strong[contains(text(), "Country")]/following-sibling::text()',
    ...
    def get_performers(self, response):
        ...
        for performer in performers:
            meta['name'] = performer.xpath('./@title').get().strip()

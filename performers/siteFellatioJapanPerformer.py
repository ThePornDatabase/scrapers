...
class siteFellatioJapanPerformerSpider(BasePerformerScraper):
    selector_map = {
        'name': '//h1[1]/text()',
    ...
    def get_performers(self, response):
        performers = response.xpath('//span/a[contains(@href,"girl/")]/@href').getall()
        for performer in performers:
            performer = "https://www.fellatiojapan.com/en/" + performer

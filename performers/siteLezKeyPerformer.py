...
class SiteLezKeyPerformerSpider(BasePerformerScraper):
    name = 'LezKeyPerformer'
    start_url = 'https://lezkey.com/'
    ...
    def start_requests(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://lezkey.com/', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_performers(self, response):
        ...
        for performer in jsondata:
            ...
            item['piercings'] = ''
            item['tattoos'] = ''
            item['network'] = 'Benefit Monkey'
            item['url'] = f"https://lezkey.com/models/{performer['slug']}"

...
class SiteExposedNursesPerformerSpider(BasePerformerScraper):
    selector_map = {
        'pagination': '',
        'external_id': r'model/(.*)/'
    }

    name = 'ExposedNursesPerformer'
    network = 'Apollo Cash'
    ...
    def start_requests(self):
        ...
        link = "https://www.exposednurses.com/pussy-hd.php?pagea="
    ...
    def parse_performer(self, response):
        ...
        image = response.xpath('//img[@class="image1" and contains(@src, "1_1")]/@src')
        if image:

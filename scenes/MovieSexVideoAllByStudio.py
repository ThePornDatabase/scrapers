...
class MovieSexVideoAllByStudioSpider(BaseSceneScraper):
    ...
    def start_requests_2(self, response):
        ...
        for studio in self.studios:
            ...
            link = f"https://www.sexvideoall.com/api/item/getStudioCat/{meta['studio_id']}"
    ...
    def start_requests_3(self, response):
        ...
        meta['link'] = 'https://www.sexvideoall.com/api/item/StudioCategory'
    ...
    def get_movies(self, response):
        ...
        for movie in moviejson:
            link = f"https://www.sexvideoall.com/api/item/Getitem/{movie['id']}/x"

...
class ProjectOneServicePartTwoSpider(BaseSceneScraper):
    name = 'ProjectOneServicePartTwo'
    network = 'mindgeek'

    #  unused.  Have been split out into individual scrapers due to confusion in processes with them all hitting at once

    start_urls = [
        # 'https://www.bangbros.com',  In their own scraper
        # 'https://www.brazzersvr.com',
        # 'https://www.brazzers.com',  In their own scraper

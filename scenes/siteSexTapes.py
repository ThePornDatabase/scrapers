...
class SiteSexTapesSpider(BaseSceneScraper):
    name = 'SexTapes'

    start_url = 'https://sextapes.com/'
    ...
    def get_scenes(self, response):
        ...
        for scene in jsondata:
            meta['id'] = scene['id']
            link = f"https://sextapes.com/_next/data/{meta['buildID']}/videos/{scene['slug']}.json"
    ...
    def parse_scene(self, response):
        ...
        item['site'] = "SexTapes"
        item['parent'] = "SexTapes"
        item['network'] = "SexTapes"
        ...
        item['url'] = f"https://sextapes.com/videos/{jsondata['slug']}"

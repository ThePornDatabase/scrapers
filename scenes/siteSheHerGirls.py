...
class SiteSheHerGirlsSpider(BaseSceneScraper):
    name = 'SheHerGirls'

    start_url = 'https://shehergirls.com'
    ...
    async def start(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://shehergirls.com', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        if jsondata:
            ...
            for scene in jsondata['data']:
                item = SceneItem()
                item['site'] = "She Her Girls"
                item['parent'] = "She Her Girls"
                item['network'] = "She Her Girls"
                ...
                item['url'] = f"https://shehergirls.com/videos/{scene['slug']}"

...
class SiteDarkshadeSpider(BaseSceneScraper):
    name = 'Darkshade'

    start_url = 'https://darkshade.com/'
    ...
    def get_scenes(self, response):
        ...
        for scene in jsondata:
            meta['id'] = scene['id']
            link = f"https://darkshade.com/_next/data/{meta['buildID']}/videos/{scene['slug']}.json"
    ...
    def parse_scene(self, response):
        ...
        item['site'] = "Darkshade"
        item['parent'] = "Darkshade"
        item['network'] = "Darkshade"
        ...
        for model in jsondata['models_thumbs']:
            model_page = f"https://darkshade.com/_next/data/{response.meta['buildID']}/models/{model['slug']}.json?slug={model['slug']}"
        ...
        item['url'] = f"https://darkshade.com/videos/{jsondata['slug']}"

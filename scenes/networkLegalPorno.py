...
class LegalPornoSpider(BaseSceneScraper):
    ...
    def parse_scene(self, response):
        ...
        if self.check_item(item, self.days):
            ...
            matches = ['bangbros', 'darkkotv', 'jeffsmodels', 'private', 'antoniosuleiman', 'richardmannsworld', 'only3xnetwork', 'privateblack', 'pornforce', 'immorallive', 'girlfriendsfilms', 'majorhotwife', 'anal4k',

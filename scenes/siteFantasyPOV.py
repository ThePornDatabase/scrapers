...
class SiteFantasyPOVSpider(BaseSceneScraper):
    name = 'FantasyPOV'

    start_url = 'https://fantasypov.com/'
    ...
    async def start(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://fantasypov.com', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        for scene in jsondata:
            meta['id'] = scene['id']
            link = f"https://www.FantasyPOV.com/_next/data/{meta['buildID']}/videos/{scene['slug']}.json"
    ...
    def parse_scene(self, response):
        ...
        item['site'] = "FantasyPOV"
        item['parent'] = "FantasyPOV"
        item['network'] = "FantasyPOV"
        ...
        for model in jsondata['models_thumbs']:
            ...
            perf['site'] = "FantasyPOV"
            perf['network'] = "FantasyPOV"
        ...
        item['url'] = f"https://www.FantasyPOV.com/videos/{jsondata['slug']}"

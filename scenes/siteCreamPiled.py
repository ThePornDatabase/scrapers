...
class SiteCreamPiledSpider(BaseSceneScraper):
    name = 'CreamPiled'
    network = 'Aziani'
    parent = 'CreamPiled'
    site = 'CreamPiled'
    ...
    def get_next_page_url(self, base, page):
        ...
        pagination = 'https://azianistudios.com/tour_api.php/content/sets?cms_set_ids=&data_types=1&content_count=1&count=24&start=<PAGE>&cms_area_id=11&cms_block_id=113084&orderby=published_desc&content_type=video&status=enabled&text_search=&slug=&data_type_search=%7B%223%22:%2223%22%7D'
    ...
    def start_requests(self):
        ...
        link = "https://creampiled.com/creampile-videos?page=1"
    ...
    def get_scenes(self, response):
        ...
        for scene in scenes['sets']:
            ...
            item['url'] = f"https://creampiled.com/video/{item['id']}"
            item['tags'] = []
            ...
            item['site'] = 'CreamPiled'
            item['parent'] = 'CreamPiled'
            item['network'] = 'Aziani'
            item['performers'] = []
            for dataset in scene['data_types']:

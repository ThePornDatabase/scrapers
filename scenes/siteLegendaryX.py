...
class SiteLegendaryXSpider(BaseSceneScraper):
    name = 'LegendaryX'

    start_url = 'https://legendaryx.com/'
    ...
    def start_requests(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://legendaryx.com/', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        for scene in jsondata:
            ...
            item['url'] = f"https://legendaryx.com/episodes/{scene['slug']}"

            item['tags'] = scene['tags']

            item['duration'] = scene['seconds_duration']
            item['site'] = 'LegendaryX'
            item['parent'] = 'LegendaryX'
            item['network'] = 'LegendaryX'
            item['performers'] = []

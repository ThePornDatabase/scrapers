...
class SiteLukeCooperXSpider(BaseSceneScraper):
    name = 'LukeCooperX'

    start_url = 'https://lukecooperx.com'
    ...
    async def start(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://lukecooperx.com', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        for scene in jsondata:
            ...
            item['id'] = scene['id']
            item['url'] = f"https://lukecooperx.com/videos/{scene['slug']}"
            item['site'] = 'LukeCooperX'
            item['tags'] = []
            if "tags" in scene:
                item['tags'] = scene['tags']
            item['duration'] = scene['seconds_duration']
            item['parent'] = 'LukeCooperX'
            item['network'] = 'LukeCooperX'
            item['performers'] = []

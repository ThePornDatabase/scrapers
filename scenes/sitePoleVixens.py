...
class SitePoleVixensSpider(BaseSceneScraper):
    name = 'PoleVixens'

    start_url = 'https://polevixens.com'
    ...
    async def start(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://polevixens.com', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        if jsondata:
            ...
            for scene in jsondata['data']:
                item = SceneItem()
                item['site'] = "Pole Vixens"
                item['parent'] = "Pole Vixens"
                item['network'] = "Pole Vixens"
                ...
                item['url'] = f"https://polevixens.com/videos/{scene['slug']}"

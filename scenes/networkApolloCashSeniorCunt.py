...
class NetworkApolloCashSeniorCuntSpider(BaseSceneScraper):
    name = 'ApolloCashSeniorCunt'
    network = 'Apollo Cash'

    start_urls = [
        'https://www.seniorcunt.com',
    ]
    ...
    def get_scenes(self, response):
        ...
        for scene in scenes:
            ...
            image = scene.xpath('.//img[contains(@alt, "SeniorCunt")]/@src')
            if image:
            ...
            item['site'] = "Senior Cunt"
            item['parent'] = "Senior Cunt"

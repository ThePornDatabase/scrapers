...
class SiteCMNMSpider(BaseSceneScraper):
    name = 'CMNM'
    ...
    selector_map = {
        'external_id': r'',
        'pagination': '/tag/cmnm-net/page/%s/',
    }
    ...
    def get_scenes(self, response):
        ...
        for scene in scenes:
            ...
            item['tags'] = scene.xpath('.//i[contains(@class, "fa-tags")]/following-sibling::a[contains(@href, "/fetishes/")]/text()').getall()

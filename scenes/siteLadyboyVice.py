...
class SiteLadyboyViceSpider(BaseSceneScraper):
    name = 'LadyboyVice'

    start_urls = [
        'https://ladyboyvice.com',
    ]

    headers = {
        'Accept': 'application/json, text/plain, */*',
        'Accept-Language': 'en-US,en;q=0.9',
        'Origin': 'https://ladyboyvice.com',
        'Referer': 'https://ladyboyvice.com/',
        'Sec-Fetch-Dest': 'empty',
        'Sec-Fetch-Mode': 'cors',
        'Sec-Fetch-Site': 'cross-site',
        'X-NATS-cms-area-id': 'c594b28c-ab09-44da-9166-0a332d33469f',
        'X-NATS-Entity-Decode': '1'
    }
    
    cookies = [
        {"domain": "ladyboyvice.com", "name": "consent",     "path": "/", "value": "true"},
    ]
    ...
    nats_site = 'https://www.ladyboyvice.com'
    nats_block_fallback = '105983'
    ...
    def get_next_page_url(self, base, page):
        ...
        url = f"https://nats.islanddollars.com/tour_api.php/content/sets?cms_set_ids=&data_types=1&content_count=1&count=12&start={index}&cms_area_id=c594b28c-ab09-44da-9166-0a332d33469f&cms_block_id={self.nats_block_id}&orderby=published_desc&content_video_orientation=horizontal,vertical,square&content_type=video&status=enabled&text_search=&data_type_search=%7B%22100001%22:%22185%22%7D"
        return url
    ...
    def get_scenes(self, response):
        ...
        for scene in scenes:
                    ...
                    if data_type['cms_data_type_id'] == "4":
                        if "data_values" in data_type and data_type['data_values']:
                            for value in data_type['data_values']:
                                ...
                                perf['site'] = "Ladyboy Vice"
                                perf['network'] = "Ladyboy Vice"
                                perf['extra'] = {}
            ...
            item['trailer'] = ""
            item['url'] = f"https://ladyboyvice.com/index.php?section=1681&start={str(int(meta['page']) * 48)}"
            item['network'] = "Ladyboy Vice"
            item['parent'] = "Ladyboy Vice"
            item['site'] = "Ladyboy Vice"

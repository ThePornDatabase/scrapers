...
class SiteBrutalFacesittingSpider(BaseSceneScraper):
    name = 'BrutalFacesitting'

    start_urls = [
        'https://brutal-facesitting.com',
    ]
    ...
    def get_scenes(self, response):
        ...
        for scene in scenes:
            ...
            if item['title']:
                ...
                item['trailer'] = ''
                item['tags'] = ['FemDom']
                item['url'] = "https://brutal-facesitting.com/" + item['id']
                item['site'] = "Brutal Facesitting"
                item['parent'] = "Brutal Facesitting"

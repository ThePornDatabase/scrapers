...
class NaughtyAmericaVRSpider(BaseSceneScraper):
    ...
    def get_scenes(self, response):
        meta = response.meta
        scenes = response.xpath('//div[@class="scene-item"]/a[1]/@href').getall()
        for scene in scenes:

...
class SiteThaiSwingerSpider(BaseSceneScraper):
    ...
    nats_site = 'https://www.thaiswinger.com'
    nats_block_fallback = '105090'
    ...
    def get_next_page_url(self, base, page):
        ...
        url = f"https://nats.islanddollars.com/tour_api.php/content/sets?cms_set_ids=&data_types=1&content_count=1&count=48&start={index}&cms_area_id=4ab4cd6a-6644-489e-83cf-f7be8adb759a&cms_block_id={self.nats_block_id}&orderby=published_desc&content_type=video&status=enabled&text_search=&data_type_search=%7B%22100001%22%3A%22171%22%7D"
        return url

...
class SiteSeskaSpider(BaseSceneScraper):
    name = 'Seska'

    start_url = 'https://tour.seska.com/'
    ...
    def start_requests(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://tour.seska.com/', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        jsondata = jsondata['pageProps']['latest_contents']['data']
        for scene in jsondata:
            ...
            item['url'] = f"https://tour.seska.com/scenes/{scene['slug']}"
            ...
            if "Seska" not in item['performers']:
                item['performers'].append("Seska")

...
class SiteLadyboyGoldByPerformerSpider(BaseSceneScraper):
    name = 'LadyboyGoldByPerformer'
    site = 'Ladyboy Gold'
    parent = 'Ladyboy Gold'
    ...
    def get_scenes(self, response):
        ...
        for scene in scenes:
            ...
            item['performers'] = response.xpath('//div[@class="container"]/div[1]/div[2]/div[1]/text()').getall()

...
class AdultTimeAPISpider(BaseSceneScraper):
    ...
    def call_algolia(self, page, token, referrer):
        ...
        if 'agentredgirl' in referrer:
            jbody = '{"requests":[{"indexName":"all_scenes_latest_desc","params":"analytics=true&analyticsTags=%5B%22component%3Asearchlisting%22%2C%22section%3Afreetour%22%2C%22site%3Aagentredgirl%22%2C%22context%3Avideos%22%2C%22device%3Adesktop%22%5D&clickAnalytics=true&facetingAfterDistinct=true&facets=%5B%22categories.url_name%22%5D&filters=(content_tags%3A\'futa\')%20AND%20(upcoming%3A\'0\')%20AND%20availableOnSite%3Aagentredgirl&highlightPostTag=__%2Fais-highlight__&highlightPreTag=__ais-highlight__&hitsPerPage=60&maxValuesPerFacet=1000&page=' + str(page) + '&query=&tagFilters="}]}'

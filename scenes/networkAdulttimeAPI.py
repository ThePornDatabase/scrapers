...
SITE_NAMES = {
    ...
    # 21 Bonus / Adult Time Originals sub-brand names
    '21bonuscontent': '21 Bonus Content',
    'analteenclub': 'Anal Teen Club',
    'bootyfullbabes': 'Bootyfull Babes',
    'bustyfever': 'Busty Fever',
    'dailysexdose': 'Daily Sex Dose',
    'dpoverload': 'DP Overload',
    'enslavedgals': 'Enslaved Gals',
    'intermixedsluts': 'Intermixed Sluts',
    'lustforanal': 'Lust For Anal',
    'lustybustychix': 'Lusty Busty Chix',
    'oralquickies': 'Oral Quickies',
    'sexcityasia': 'Sex City Asia',
    'squirtingfiles': 'Squirting Files',
    'teenbitchclub': 'Teen Bitch Club',
    'theverybestof': 'The Very Best Of',
}
...
def match_site(argument):
    ...
    # Algolia restructured some availableOnSite values to '<name>-channel'
    # (allblackx -> allblackx-channel, ATLHardX-channel, atllesbianx-channel, ...).
    # Strip the suffix and any 'atl' brand prefix so item['site'] stays identical
    # to what it was before the rename.
    if a.endswith('-channel'):
        stripped = a[:-len('-channel')]
        for candidate in (stripped, stripped + '.com'):
            if candidate in SITE_NAMES:
                return SITE_NAMES[candidate]
        if stripped.startswith('atl') and len(stripped) > 3:
            no_atl = stripped[3:]
            for candidate in (no_atl, no_atl + '.com'):
                if candidate in SITE_NAMES:
                    return SITE_NAMES[candidate]
...
SITE_CONFIGS = {
    ...
    ## DEAD (facet removed from Algolia index):
    ...
    'mommysboy': {'url': 'https://www.mommysboy.com', 'parent': 'Mommysboy', 'site': 'Mommys Boy'},
    ...
    ## DEAD (xempire and all sub-brand facets removed from Algolia index):
    ## 'xempire': {'url': 'https://www.xempire.com', 'parent': 'XEmpire'},
    'zerotolerance': {'url': 'https://www.zerotolerancefilms.com', 'parent': 'Zero Tolerance'},

    # ---- Auto-added from missing_channels.txt cross-reference ----
    # These are channels that existed in the FansDB Algolia index but had no
    # SITE_CONFIGS entry and no matching scraper in scenes/. Deduplicated across
    # the plain / -channel facet-name split. Network filled from Algolia data;
    # site/parent set to the display name. Adjust manually as needed.
    '21bonuscontent': {'url': 'https://www.adulttime.com/series/21bonuscontent', 'parent': 'Theverybestof', 'network': '21 Bonus'},
    '3dgspot': {'url': 'https://www.adulttime.com/series/3dgspot', 'parent': '3dgspot', 'site': '3dgspot', 'network': '3DGSpot'},
    'accidentalgangbang': {'url': 'https://www.adulttime.com/series/accidentalgangbang', 'parent': 'Accidentalgangbang', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'adulttimepilots': {'url': 'https://www.adulttime.com/series/adulttimepilots', 'parent': 'AdultTimePilots', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'all-sexstudio': {'url': 'https://www.adulttime.com/series/all-sexstudio', 'parent': 'All-sexstudio', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'altshift': {'url': 'https://www.adulttime.com/series/altshift', 'parent': 'AltSHIFT', 'site': 'AltSHIFT', 'network': 'AltSHIFT'},
    'analteenclub': {'url': 'https://www.adulttime.com/series/analteenclub', 'parent': 'Analteenclub', 'site': 'Analteenclub', 'network': '21 Bonus'},
    'animeshinclub': {'url': 'https://www.adulttime.com/series/animeshinclub', 'parent': 'Animeshinclub', 'site': 'Animeshinclub', 'network': 'Animeshin Club'},
    'atldisruptivefilms': {'url': 'https://www.adulttime.com/series/atldisruptivefilms', 'parent': 'ATLDisruptiveFilms', 'site': 'ATLDisruptiveFilms', 'network': 'Disruptive Films'},
    'between-the-sheets-with-alison-rey-': {'url': 'https://www.adulttime.com/series/between-the-sheets-with-alison-rey-', 'parent': 'Between-The-Sheets-with-Alison-Rey-channel Adult Time Originals', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'bifuck': {'url': 'https://www.adulttime.com/series/bifuck', 'parent': 'Bifuck', 'site': 'Bifuck', 'network': 'BiFuck'},
    'birth': {'url': 'https://www.adulttime.com/series/birth', 'parent': 'Birth', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'blacklabelmag': {'url': 'https://www.adulttime.com/series/blacklabelmag', 'parent': 'Blacklabelmag', 'site': 'Blacklabelmag', 'network': 'Black Label Mag'},
    'blackmoneyerotica': {'url': 'https://www.adulttime.com/series/blackmoneyerotica', 'parent': 'Blackmoneyerotica', 'site': 'Blackmoneyerotica', 'network': 'Black Money Erotica'},
    'bonuscontent': {'url': 'https://www.adulttime.com/series/bonuscontent', 'parent': 'Bonuscontent', 'site': 'Bonuscontent', 'network': 'Bonus Content'},
    'bootyfullbabes': {'url': 'https://www.adulttime.com/series/bootyfullbabes', 'parent': 'Bootyfullbabes', 'site': 'Bootyfullbabes', 'network': '21 Bonus'},
    'bubblegumdungeon': {'url': 'https://www.adulttime.com/series/bubblegumdungeon', 'parent': 'Bubblegumdungeon', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'bustyfever': {'url': 'https://www.adulttime.com/series/bustyfever', 'parent': 'Bustyfever', 'site': 'Bustyfever', 'network': '21 Bonus'},
    'cardiogasm': {'url': 'https://www.adulttime.com/series/cardiogasm', 'parent': 'Cardiogasm', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'caseyatruestory': {'url': 'https://www.adulttime.com/series/caseyatruestory', 'parent': 'Casey: A True Story', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'criticalmassvideo': {'url': 'https://www.adulttime.com/series/criticalmassvideo', 'parent': 'CriticalMassVideo', 'site': 'CriticalMassVideo', 'network': 'Critical Mass Video'},
    'customerservice': {'url': 'https://www.adulttime.com/series/customerservice', 'parent': 'Customerservice', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'daddysboy': {'url': 'https://www.adulttime.com/series/daddysboy', 'parent': 'Daddysboy', 'site': 'Daddysboy', 'network': 'Heteroflexible'},
    'dailysexdose': {'url': 'https://www.adulttime.com/series/dailysexdose', 'parent': 'Dailysexdose', 'site': 'Dailysexdose', 'network': '21 Bonus'},
    'dareweshare': {'url': 'https://www.adulttime.com/series/dareweshare', 'parent': 'Dareweshare', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'dpoverload': {'url': 'https://www.adulttime.com/series/dpoverload', 'parent': 'Dpoverload', 'site': 'Dpoverload', 'network': '21 Bonus'},
    'enslavedgals': {'url': 'https://www.adulttime.com/series/enslavedgals', 'parent': 'Enslavedgals', 'site': 'Enslavedgals', 'network': '21 Bonus'},
    'extremepickups': {'url': 'https://www.adulttime.com/series/extremepickups', 'parent': 'Extremepickups', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'feedme': {'url': 'https://www.adulttime.com/series/feedme', 'parent': 'Feedme', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'forbiddenseductions': {'url': 'https://www.adulttime.com/series/forbiddenseductions', 'parent': 'Forbiddenseductions', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'forbvr': {'url': 'https://www.adulttime.com/series/forbvr', 'parent': 'Forbvr', 'site': 'Forbvr', 'network': 'FORBVR'},
    'futasentaisquad': {'url': 'https://www.adulttime.com/series/futasentaisquad', 'parent': 'Futasentaisquad', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'futaworld-at': {'url': 'https://www.adulttime.com/series/futaworld-at', 'parent': 'Futaworld-at', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'getupclose': {'url': 'https://www.adulttime.com/series/getupclose', 'parent': 'Getupclose', 'site': 'Getupclose', 'network': 'Up Close'},
    'gostuckyourself': {'url': 'https://www.adulttime.com/series/gostuckyourself', 'parent': 'GoStuckYourself', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'grinders': {'url': 'https://www.adulttime.com/series/grinders', 'parent': 'Grinders', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'haileyroseshowcase': {'url': 'https://www.adulttime.com/series/haileyroseshowcase', 'parent': 'Haileyroseshowcase', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'hentaisexschool': {'url': 'https://www.adulttime.com/series/hentaisexschool', 'parent': 'Hentaisexschool', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'heteroflexible': {'url': 'https://www.adulttime.com/series/heteroflexible', 'parent': 'Heteroflexible', 'site': 'Heteroflexible', 'network': 'Heteroflexible'},
    'howmenorgasm': {'url': 'https://www.adulttime.com/series/howmenorgasm', 'parent': 'Howmenorgasm', 'site': 'Howmenorgasm', 'network': 'Heteroflexible'},
    'howwomenorgasm': {'url': 'https://www.adulttime.com/series/howwomenorgasm', 'parent': 'Howwomenorgasm', 'site': 'Howwomenorgasm', 'network': 'Up Close'},
    'intermixedsluts': {'url': 'https://www.adulttime.com/series/intermixedsluts', 'parent': 'Intermixedsluts', 'site': 'Intermixedsluts', 'network': '21 Bonus'},
    'intimatelypov': {'url': 'https://www.adulttime.com/series/intimatelypov', 'parent': 'Intimatelypov', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'joimom': {'url': 'https://www.adulttime.com/series/joimom', 'parent': 'JOIMom', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'lustforanal': {'url': 'https://www.adulttime.com/series/lustforanal', 'parent': 'Lustforanal', 'site': 'Lustforanal', 'network': '21 Bonus'},
    'lustybustychix': {'url': 'https://www.adulttime.com/series/lustybustychix', 'parent': 'Lustybustychix', 'site': 'Lustybustychix', 'network': '21 Bonus'},
    'milfoverload': {'url': 'https://www.adulttime.com/series/milfoverload', 'parent': 'Milfoverload', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'myyoungerlover': {'url': 'https://www.adulttime.com/series/myyoungerlover', 'parent': 'Myyoungerlover', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'oopsieanimated': {'url': 'https://www.adulttime.com/series/oopsieanimated', 'parent': 'Oopsieanimated', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'oralquickies': {'url': 'https://www.adulttime.com/series/oralquickies', 'parent': 'Oralquickies', 'site': 'Oralquickies', 'network': '21 Bonus'},
    'povmassage': {'url': 'https://www.adulttime.com/series/povmassage', 'parent': 'Povmassage', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'preggoworld': {'url': 'https://www.adulttime.com/series/preggoworld', 'parent': 'Preggoworld', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'raunch': {'url': 'https://www.adulttime.com/series/raunch', 'parent': 'Raunch', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'sexcityasia': {'url': 'https://www.adulttime.com/series/sexcityasia', 'parent': 'Sexcityasia', 'site': 'Sexcityasia', 'network': '21 Bonus'},
    'simulation': {'url': 'https://www.adulttime.com/series/simulation', 'parent': 'Simulation', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'sinnsage': {'url': 'https://www.adulttime.com/series/sinnsage', 'parent': 'SinnSage', 'site': 'SinnSage', 'network': 'Sinn Sage'},
    'sparksentertainment': {'url': 'https://www.adulttime.com/series/sparksentertainment', 'parent': 'Sparksentertainment', 'site': 'Sparksentertainment', 'network': 'Sparks Entertainment'},
    'squirtingfiles': {'url': 'https://www.adulttime.com/series/squirtingfiles', 'parent': 'Squirtingfiles', 'site': 'Squirtingfiles', 'network': '21 Bonus'},
    'stars': {'url': 'https://www.adulttime.com/series/stars', 'parent': 'Stars', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'superhornyfuntime': {'url': 'https://www.adulttime.com/series/superhornyfuntime', 'parent': 'SuperHornyFunTime', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'teenbitchclub': {'url': 'https://www.adulttime.com/series/teenbitchclub', 'parent': 'Teenbitchclub', 'site': 'Teenbitchclub', 'network': '21 Bonus'},
    'theadulttimepodcast': {'url': 'https://www.adulttime.com/series/theadulttimepodcast', 'parent': 'Theadulttimepodcast', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'theverybestof': {'url': 'https://www.adulttime.com/series/theverybestof', 'parent': 'Theverybestof', 'site': 'Theverybestof', 'network': '21 Bonus'},
    'theyeslist': {'url': 'https://www.adulttime.com/series/theyeslist', 'parent': 'Theyeslist', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'totalhentai': {'url': 'https://www.adulttime.com/series/totalhentai', 'parent': 'TotalHentai', 'site': 'TotalHentai', 'network': 'Total Hentai'},
    'toywithme': {'url': 'https://www.adulttime.com/series/toywithme', 'parent': 'Toywithme', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'underthebed': {'url': 'https://www.adulttime.com/series/underthebed', 'parent': 'Underthebed', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'unrelatedx': {'url': 'https://www.adulttime.com/series/unrelatedx', 'parent': 'UnrelatedX', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'upclosevr': {'url': 'https://www.adulttime.com/series/upclosevr', 'parent': 'Upclosevr', 'site': 'Upclosevr', 'network': 'Up Close'},
    'upclosex': {'url': 'https://www.adulttime.com/series/upclosex', 'parent': 'Upclosex', 'site': 'Upclosex', 'network': 'UpCloseX'},
    'watchyoucheat': {'url': 'https://www.adulttime.com/series/watchyoucheat', 'parent': 'Watchyoucheat', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'watchyoucheatvr': {'url': 'https://www.adulttime.com/series/watchyoucheatvr', 'parent': 'Watchyoucheatvr', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'womensworld': {'url': 'https://www.adulttime.com/series/womensworld', 'parent': 'Womensworld', 'site_from': 'serie_name', 'network': 'Adult Time Originals'},
    'yankscash': {'url': 'https://www.adulttime.com/series/yankscash', 'parent': 'Yankscash', 'site': 'Yankscash', 'network': 'YanksCash'},
...
# Predicates that return True if the scene should be SKIPPED.
# Use for cross-cutting "drop this scene" rules that aren't date-based.
EXTRA_SKIP_RULES = [
    # spankbanggold returns scenes from many sub-brands; only keep spankbang-branded ones
    lambda item, scene, _: (
        'spankbanggold.com' in (item.get('url') or '').lower()
        and 'spankbang' not in (item.get('site') or '').lower()
    ),
]
...
# ---------------------------------------------------------------------------
# Filter accepts both the historical facet value ({slug}) and the newer
# "{slug}-channel" variant introduced when Algolia restructured availableOnSite
# labels. Sites whose new facet has irregular capitalization (e.g. ATLLethalHardcore-channel,
# SinnSage-channel) still need an explicit entry in ALGOLIA_BODIES — Algolia facet
# filters are case-sensitive.
DEFAULT_ALGOLIA_BODY = '{{"requests":[{{"indexName":"all_scenes_latest_desc","analytics":true,"analyticsTags":["component:searchlisting","section:freetour","site:{slug}","context:videos","device:desktop"],"clickAnalytics":true,"facetingAfterDistinct":true,"facets":["categories.url_name"],"filters":"(upcoming:\'0\') AND (availableOnSite:\'{slug}\' OR availableOnSite:\'{slug}-channel\')","highlightPostTag":"__/ais-highlight__","highlightPreTag":"__ais-highlight__","hitsPerPage":60,"maxValuesPerFacet":1000,"page":{page},"query":""}}]}}'
...
ALGOLIA_BODIES = {
    ...
    # DEAD (facet no longer in Algolia index; SITE_CONFIGS entry already commented):
    ...
    # DEAD (falconstudios/hothouse facets removed from index):
    ...
    'gangbangcreampie': '{"requests":[{"indexName":"all_scenes","params":"query=&maxValuesPerFacet=1000&page={page}&highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&facets=%5B%22availableOnSite%22%2C%22categories.name%22%5D&tagFilters=&facetFilters=%5B%5B%22availableOnSite%3Agangbangcreampie-channel%22%5D%5D"},{"indexName":"all_scenes","params":"query=&maxValuesPerFacet=1000&page=0&highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&hitsPerPage=1&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=availableOnSite"}]}',
    ...
    # DEAD (gloryholesecrets facet removed from index):
    ...
    'hardx.com': '{"requests":[{"indexName":"all_scenes","params":"query=&maxValuesPerFacet=1000&page={page}&highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&filters=&facets=%5B%22availableOnSite%22%2C%22categories.name%22%5D&tagFilters=&facetFilters=%5B%5B%22availableOnSite%3AATLHardX-channel%22%5D%5D"}]}',
    ...
    'lesbianx.com': '{"requests":[{"indexName":"all_scenes","params":"query=&maxValuesPerFacet=1000&page={page}&highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&filters=&facets=%5B%22availableOnSite%22%2C%22categories.name%22%5D&tagFilters=&facetFilters=%5B%5B%22availableOnSite%3Aatllesbianx-channel%22%5D%5D"}]}',
    ...
    # Oopsie uses Algolia 5.x client and its own API key — see ALGOLIA_KEY_OVERRIDES.
    # Added "page":{page} to the first request so pagination works.
    'oopsie': '{"requests":[{"indexName":"all_scenes_latest_desc","clickAnalytics":true,"facetFilters":["upcoming:0",["availableOnSite:oopsie"]],"hitsPerPage":24,"page":{page}},{"indexName":"all_scenes_latest_desc","analytics":false,"clickAnalytics":false,"facetFilters":["upcoming:0"],"facets":"availableOnSite","hitsPerPage":0,"page":0}]}',
    ...
    # DEAD (transsexualangel facet removed from index):
    ...
    # DEAD (tsfactor / shemaleidol facets removed from index):
...
# ---------------------------------------------------------------------------
# Per-site overrides for the Algolia URL params (agent + api-key). Most sites
# share the token passed to call_algolia(); a few (Oopsie, ...) run a newer
# Algolia client with its own api-key and must be sent as-captured or the
# server rejects the request. Keys match SITE_CONFIGS.
# ---------------------------------------------------------------------------
ALGOLIA_KEY_OVERRIDES = {
    'oopsie': {
        'agent': 'Algolia%20for%20JavaScript%20(5.50.1)%3B%20Search%20(5.50.1)%3B%20Browser%3B%20JS%20Helper%20(3.28.1)',
        'api_key': '5d92d1655fd1af6536ec90cd19c26a06',
    },
}
...
# ---------------------------------------------------------------------------
SKIP_SITENAME_SUBSTRINGS = ('evilangelpartner', 'nudefightclub', 'nakedsword')
...
class AdultTimeAPISpider(BaseSceneScraper):
    ...
    def _populate_site_fields(self, item, scene, site_key, cfg, referrer_url):
        ...
        if 'site_from' in cfg:
            ...
            # Adult Time tags every "Originals" scene with the generic sitename
            # 'adulttime'; the specific series is only in serie_name/mainChannel.
            # When our config has an explicit 'site' and we got the generic
            # catch-all back, prefer the config's intent.
            GENERIC_SITENAMES = {'adulttime', 'adult time', 'adulttime films', 'adult time films'}
            is_generic = sitename.lower() in GENERIC_SITENAMES
            if 'site' in cfg and (translated == sitename or is_generic):
                item['site'] = cfg['site']
            else:
    ...
    def _should_skip(self, item, scene, referrer_url, cfg):
        ...
        for predicate in EXTRA_SKIP_RULES:
            if predicate(item, scene, referrer_url):
                return True
    ...
    def call_algolia(self, page, token, referrer):
        ...
        # Per-site agent/api-key override (e.g. sites on the newer Algolia client)
        override = ALGOLIA_KEY_OVERRIDES.get(site_key)
        if override:
            agent = override.get('agent', agent)
            token = override.get('api_key', token)
        ...
        if site_key in ALGOLIA_BODIES:
            ...
            # DEFAULT_ALGOLIA_BODY filters on availableOnSite:{slug}. Use site_key
            # directly when we have one — it IS the availableOnSite value we want.
            # Legacy path (referrer without a matching SITE_CONFIGS entry) falls
            # back to the old first-domain-segment extraction.
            if site_key:
                slug = site_key.split('.')[0]  # strip any '.com' suffix from key
            else:

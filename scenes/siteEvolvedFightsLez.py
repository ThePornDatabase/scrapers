...
class SiteEvolvedFightsLezSpider(BaseSceneScraper):
    name = 'EvolvedFightsLez'
    site = 'Evolved Fights Lez'
    parent = 'Evolved Fights'
    network = 'Evolved Fights'

    start_urls = [
        # 'https://www.evolvedfights.com', Split to its own scraper

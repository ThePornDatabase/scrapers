...
class MovieBizarreVideoSpider(BaseSceneScraper):
    name = 'MovieBizarreVideo'
    network = 'Bizarre Entertainment'
    parent = 'Bizarre Entertainment'
    site = 'Bizarre Entertainment'

    start_urls = [
        'https://www.bizarrevideo.com'
    ]
    ...
    selector_map = {
        ...
        'external_id': 'scene/(\\d+)',
        'trailer': '',
        'pagination': '/bizarre-entertainment-best-selling-porn-videos.html?sort=released&page=%s&studio=202'
    }
    ...
    def parse_movie(self, response):
        ...
        if len(sceneurls) > 1:
            item = SceneItem()
            item['network'] = 'Bizarre Entertainment'
            item['parent'] = 'Bizarre Entertainment'
            item['site'] = 'Bizarre Entertainment'

...
class MovieAyloAPISpider(BaseSceneScraper):
    ...
    def get_movies(self, response):
        ...
        for scene in response.json()['result']:
            ...
            item['site'] = "Transsensual"
            item['parent'] = "Transsensual"
            item['network'] = "Mind Geek"

            item['url'] = f"https://www.transsensual.com/movie/{scene['id']}/{slugify(item['title'])}"
                ...
                if self.check_item(item, self.days):
                    ...
                    for child in scene['children']:
                        if "type" in child and child['type'].lower() == "scene":
                            ...
                            # ~ link = f"https://site-api.project1service.com/v2/releases/{child['id']}?blockId=118331&blockName=PlayerBlock&pageType=WATCH_TRAILER"
    ...
    def parse_scene(self, scene, movie):
        ...
        item['url'] = f"https://www.transsensual.com/scene/{scene['id']}/{slugify(item['title'])}"
        ...
        if len(performer_list):
            for performer in performer_list:
                ...
                if "gender" in performer and performer['gender']:
                    ...
                    perf['network'] = "Mind Geek"
                    perf['site'] = "Transsensual"
